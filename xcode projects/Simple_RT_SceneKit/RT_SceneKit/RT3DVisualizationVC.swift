...
class RT3DVisualizationVC: UIViewController, SCNSceneRendererDelegate {
    var gameTime: Int = 0
    
    public var scnView = SCNView(frame: CGRect(x: 0,y: 0,width: UIScreen.main.bounds.width,height: UIScreen.main.bounds.height))
    ...
    override func viewDidLoad() {
        ...
        // create a new scene
        let scene = SCNScene(named: "art.scnassets/rt_vis.scn")!
        ...
        scnView.addSubview(dPadBtnUp)
        scnView.addSubview(dPadBtnDown)
        scnView.addSubview(dPadBtnLeft)
        scnView.addSubview(dPadBtnRight)
